...
public class Browse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Browse(CharSequence type, maestro.components.Header header, java.util.List<maestro.components.Slot> slots) {
    this.type = type;
    this.header = header;
    this.slots = slots;
  }
  ...
  public static maestro.layouts.Browse.Builder newBuilder() {
    return new maestro.layouts.Browse.Builder();
  }

  /** Creates a new Browse RecordBuilder by copying an existing Builder */
  public static maestro.layouts.Browse.Builder newBuilder(maestro.layouts.Browse.Builder other) {
    return new maestro.layouts.Browse.Builder(other);
  }

  /** Creates a new Browse RecordBuilder by copying an existing Browse instance */
  public static maestro.layouts.Browse.Builder newBuilder(maestro.layouts.Browse other) {
    return new maestro.layouts.Browse.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Browse>
    ...
    private Builder() {
      super(maestro.layouts.Browse.SCHEMA$);
    }

    /** Creates a Builder by copying an existing Builder */
    private Builder(maestro.layouts.Browse.Builder other) {
      super(other);
    ...
    private Builder(maestro.layouts.Browse other) {
            super(maestro.layouts.Browse.SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'type' field */
    public maestro.layouts.Browse.Builder setType(CharSequence value) {
    ...
    public maestro.layouts.Browse.Builder clearType() {
      type = null;
    ...
    /** Sets the value of the 'header' field */
    public maestro.layouts.Browse.Builder setHeader(maestro.components.Header value) {
    ...
    public maestro.layouts.Browse.Builder clearHeader() {
      header = null;
    ...
    /** Sets the value of the 'slots' field */
    public maestro.layouts.Browse.Builder setSlots(java.util.List<maestro.components.Slot> value) {
    ...
    public maestro.layouts.Browse.Builder clearSlots() {
      slots = null;
